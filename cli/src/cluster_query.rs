use {
    ...
    chui_transaction_status::UiTransactionEncoding,
...
impl ClusterQuerySubCommands for App<'_, '_> {
    fn cluster_query_subcommands(self) -> Self {
        ...
        .subcommand(
            SubCommand::with_name("supply").about("Get information about the cluster supply of CUI")
            .arg(
        ...
        .subcommand(
            SubCommand::with_name("total-supply").about("Get total number of CUI")
            ...
            SubCommand::with_name("rent")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display rent in lamports instead of CUI"),
                ),
        )
    }
}
...
pub fn process_catchup(
    ...
    loop {
        ...
        // especially if pointing to api.meinnet-beta.chui.network at times
...
pub fn process_total_supply(rpc_client: &RpcClient, _config: &CliConfig) -> ProcessResult {
    ...
    Ok(format!("{} CUI", lamports_to_cui(supply.total)))
}
...
pub fn process_show_stakes(
    ...
    let mut program_accounts_config = RpcProgramAccountsConfig {
        account_config: RpcAccountInfoConfig {
            encoding: Some(chui_account_decoder::UiAccountEncoding::Base64),
...
pub fn process_show_validators(
    ...
    let majority_count = vote_accounts
        ...
        .iter()
        .filter(|v| {
            v.activated_stake >= chui_vote_program::MIN_STAKERS_TO_BE_MAJORITY
        })
        .count() as u64;
...
mod tests {
    use {
        ...
        chui_sdk::signature::{write_keypair, Keypair},
        std::str::FromStr,
