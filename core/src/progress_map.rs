use {
    ...
    chui_ledger::blockstore_processor::{ConfirmationProgress, ConfirmationTiming},
    chui_runtime::{bank::Bank, bank_forks::BankForks, vote_account::VoteAccount},
    chui_sdk::{clock::Slot, hash::Hash, pubkey::Pubkey},
    std::{
...
mod test {
    ...
    fn test_add_vote_pubkey() {
        ...
        let mut vote_pubkey = chui_sdk::pubkey::new_rand();
        ...
        vote_pubkey = chui_sdk::pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(chui_sdk::pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = chui_sdk::pubkey::new_rand();
        ...
        // shouldn't increase
        node_pubkey = chui_sdk::pubkey::new_rand();
        stats.add_node_pubkey_internal(&node_pubkey, &vote_account_pubkeys, &epoch_vote_accounts);
        assert!(stats.propagated_node_ids.contains(&node_pubkey));
        assert_eq!(
            stats.propagated_validators_stake,
