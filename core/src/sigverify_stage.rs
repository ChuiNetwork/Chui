...
use {
    ...
    chui_sdk::timing,
    chui_streamer::streamer::{self, PacketBatchReceiver, StreamerError},
    std::{
...
impl SigVerifyStage {
    ...
    fn verifier<T: SigVerifier>(
        ...
        let non_discarded_packets = chui_perf::discard::discard_batches_randomly(
            &mut batches,
            MAX_DEDUP_BATCH,
            num_packets,
        );
...
mod tests {
    ...
    use chui_perf::{packet::to_packet_batches, sigverify::count_packets_in_batches};
    use std::sync::mpsc::channel;
    use {super::*, chui_perf::packet::Packet};
