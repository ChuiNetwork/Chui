...
cat >/etc/apt/apt.conf.d/99-chui<<'EOF'
...
"$CUI_ROOT"/net/scripts/install-docker.sh
usermod -aG docker "$SETUP_USER"
"$CUI_ROOT"/net/scripts/install-certbot.sh
...
"$CUI_ROOT"/net/scripts/install-earlyoom.sh
"$CUI_ROOT"/net/scripts/install-nodejs.sh
"$CUI_ROOT"/net/scripts/localtime.sh
"$CUI_ROOT"/net/scripts/install-redis.sh
"$CUI_ROOT"/net/scripts/install-rsync.sh
"$CUI_ROOT"/net/scripts/install-libssl-compatability.sh
