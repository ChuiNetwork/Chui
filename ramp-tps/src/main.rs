//! Ramp up TPS for Tour de CUI until all validators drop out
...
const DEFAULT_INITIAL_CUI_BALANCE: &str = "1";
    ...
    let matches = App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("initial_balance")
                ...
                .value_name("CUI")
                .takes_value(true)
                .default_value(DEFAULT_INITIAL_CUI_BALANCE)
                .help("The number of CUI that each partipant started with"),
        )
        .arg(
