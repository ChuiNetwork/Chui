...
use {
    ...
    log::*,
    rayon::prelude::*,
    chui_client::perf_utils::{sample_txs, SampleStats},
    chui_core::gen_keys::GenKeys,
    chui_faucet::faucet::request_airdrop_transaction,
    chui_measure::measure::Measure,
    chui_metrics::{self, datapoint_info},
    chui_sdk::{
        client::Client,
...
mod tests {
    use {
        super::*,
        chui_runtime::{bank::Bank, bank_client::BankClient},
        chui_sdk::{
