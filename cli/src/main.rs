use {
    ...
    chui_cli_config::Config,
    chui_cli_output::{display::println_name_value, OutputFormat},
    chui_client::rpc_config::RpcSendTransactionConfig,
...
fn main() -> Result<(), Box<dyn error::Error>> {
    chui_logger::setup_with_default("off");
