use {
    ...
    solana_sdk::{genesis_config::GenesisConfig, native_token::LAMPORTS_PER_CUI},
};
...
pub const CREATOR_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 500_000 * LAMPORTS_PER_CUI,
    ...
    StakerInfo {
        ...
        lamports: 200_000 * LAMPORTS_PER_CUI,
    ...
    StakerInfo {
        ...
        lamports: 365_000 * LAMPORTS_PER_CUI,
    ...
    StakerInfo {
        ...
        lamports: 103_519 * LAMPORTS_PER_CUI,
...
pub const SERVICE_STAKER_INFOS: &[StakerInfo] = &[
    StakerInfo {
        ...
        lamports: 25_000 * LAMPORTS_PER_CUI,
...
pub const FOUNDATION_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 5_700_000 * LAMPORTS_PER_CUI,
...
pub const GRANTS_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 1_500_000 * LAMPORTS_PER_CUI,
...
pub const COMMUNITY_STAKER_INFOS: &[StakerInfo] = &[
    ...
    StakerInfo {
        ...
        lamports: 3_001_032 * LAMPORTS_PER_CUI,
    ...
    StakerInfo {
        ...
        lamports: 15_333_633 * LAMPORTS_PER_CUI + 41 * LAMPORTS_PER_CUI / 100,
...
pub fn add_genesis_accounts(genesis_config: &mut GenesisConfig, mut issued_lamports: u64) {
    ...
    // "Chui Serengeti" (community pool) gets 50_000_000CUI (total) - above distributions
    create_and_add_stakes(
        genesis_config,
        &StakerInfo {
            name: "Chui Serengeti",
            staker: "7vEAL3nS9CWmy1q6njUUyHE7Cf5RmyQpND6CsoHjzPiR",
            lamports: (50_000_000 * LAMPORTS_PER_CUI).saturating_sub(issued_lamports),
...
mod tests {
    ...
    fn test_add_genesis_accounts() {
        ...
        assert_eq!(50_000_000 * LAMPORTS_PER_CUI, lamports);
    }
}
