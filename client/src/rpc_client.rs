//! Communication with a Chui node over RPC.
//!
//! Software that interacts with the Chui blockchain, whether querying its
//! state or submitting transactions, communicates with a Chui node over
...
use {
    ...
    chui_vote_program::vote_state::MAX_LOCKOUT_HISTORY,
    std::{
        cmp::min,
        net::SocketAddr,
        str::FromStr,
...
/// A client of a remote Chui node.
///
/// `RpcClient` communicates with a Chui node over [JSON-RPC], with the
/// [Chui JSON-RPC protocol][jsonprot]. It is the primary Rust interface for
...
/// [jsonprot]: https://docs.chui.network/developing/clients/jsonrpc-api
/// [JSON-RPC]: https://www.jsonrpc.org/specification
/// [slots]: https://docs.chui.network/terminology#slot
/// [cl]: https://docs.chui.network/developing/clients/jsonrpc-api#configuring-state-commitment
///
/// # Errors
///
...
///
/// ```
/// # use chui_sdk::system_transaction;
/// # use chui_client::rpc_client::RpcClient;
/// # use chui_client::client_error::ClientError;
/// # use chui_sdk::signature::{Keypair, Signer};
/// # use chui_sdk::hash::Hash;
/// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
/// # let key = Keypair::new();
/// # let to = chui_sdk::pubkey::new_rand();
/// # let lamports = 50;
...
impl RpcClient {
    ...
    ///
    /// ```
    /// # use chui_sdk::commitment_config::CommitmentConfig;
    /// # use chui_client::rpc_client::RpcClient;
    /// let url = "http://localhost:8899".to_string();
    ...
    fn get_node_version(&self) -> Result<semver::Version, RpcError> {
        ...
        if let Some(version) = &*r_node_version {
            ...
            let node_version = semver::Version::parse(&node_version.chui_core).map_err(|e| {
    ...
    // to keep interface compatible with chui
    ...
    ///
    /// [`sendTransaction`]: https://docs.chui.network/developing/clients/jsonrpc-api#sendtransaction
    /// [`getLatestBlockhash`]: https://docs.chui.network/developing/clients/jsonrpc-api#getlatestblockhash
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSignatureStatuses`]: https://docs.chui.network/developing/clients/jsonrpc-api#getsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// ["preflight check"]: https://docs.chui.network/developing/clients/jsonrpc-api#sendtransaction
    ///
    ...
    ///
    /// [`simulateTransaction`]: https://docs.chui.network/developing/clients/jsonrpc-api#simulatetransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getHighestSnapshotSlot`]: https://docs.chui.network/developing/clients/jsonrpc-api#gethighestsnapshotslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`TransactionError`]: chui_sdk::transaction::TransactionError
    ///
    /// This function only searches a node's recent history, including all
    /// recent slots, plus up to
    /// [`MAX_RECENT_BLOCKHASHES`][chui_sdk::clock::MAX_RECENT_BLOCKHASHES]
    ...
    /// This method is built on the [`getSignatureStatuses`] RPC method.
    ///
    /// [`getSignatureStatuses`]: https://docs.chui.network/developing/clients/jsonrpc-api#gitsignaturestatuses
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlot`]: https://docs.chui.network/developing/clients/jsonrpc-api#getslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockHeight`]: https://docs.chui.network/developing/clients/jsonrpc-api#getblockheight
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSlotLeaders`]: https://docs.chui.network/developing/clients/jsonrpc-api#getslotleaders
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     client_error::ClientError,
    /// # };
    /// # use chui_sdk::slot_history::Slot;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// let start_slot = 1;
    /// let limit = 3;
    ...
    ///
    /// [`getBlockProduction`]: https://docs.chui.network/developing/clients/jsonrpc-api#getblockproduction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getStakeActivation`]: https://docs.chui.network/developing/clients/jsonrpc-api#getstakeactivation
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSupply`]: https://docs.chui.network/developing/clients/jsonrpc-api#getsupply
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getLargestAccounts`]: https://docs.chui.network/developing/clients/jsonrpc-api#getlargestaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getVoteAccounts`]: https://docs.chui.network/developing/clients/jsonrpc-api#getvoteaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// RPC method.
    ///
    /// [`getClusterNodes`]: https://docs.chui.network/developing/clients/jsonrpc-api#getclusternodes
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getBlock`]: https://docs.chui.network/developing/clients/jsonrpc-api#getblock
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// ```
    /// # use chui_transaction_status::UiTransactionEncoding;
    /// # use chui_client::{
    /// #     rpc_client::RpcClient,
    /// #     client_error::ClientError,
    /// # };
    ...
    ///
    /// [`getBlocks`]: https://docs.chui.network/developing/clients/jsonrpc-api#getblocks
    /// [`getConfirmedBlocks`]: https://docs.chui.network/developing/clients/jsonrpc-api#getConfirmedblocks
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlocksWithLimit`]: https://docs.chui.network/developing/clients/jsonrpc-api#getblockswithlimit
    /// [`getConfirmedBlocksWithLimit`]: https://docs.chui.network/developing/clients/jsonrpc-api#getconfirmedblockswithlimit
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getSignaturesForAddress`]: https://docs.chui.network/developing/clients/jsonrpc-api#getsignaturesforaddress
    /// [`getSignaturesForAddress2`]: https://docs.chui.network/developing/clients/jsonrpc-api#getsignaturesforaddress2
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getTransaction`]: https://docs.chui.network/developing/clients/jsonrpc-api#gettransaction
    /// [`getConfirmedTransaction`]: https://docs.chui.network/developing/clients/jsonrpc-api#getconfirmedtransaction
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBlockTime`]: https://docs.chui.network/developing/clients/jsonrpc-api#getblocktime
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getEpochInfo`]: https://docs.chui.network/developing/clients/jsonrpc-api#getepochinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getLeaderSchedule`]: https://docs.chui.network/developing/clients/jsonrpc-api#getleaderschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     rpc_client::RpcClient,
    /// # };
    /// # use chui_client::rpc_config::RpcLeaderScheduleConfig;
    /// # use chui_sdk::commitment_config::CommitmentConfig;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let slot = rpc_client.get_slot()?;
    ...
    ///
    /// [`getEpochSchedule`]: https://docs.chui.network/developing/clients/jsonrpc-api#getepochschedule
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getRecentPerformanceSamples`]: https://docs.chui.network/developing/clients/jsonrpc-api#getrecentperformancesamples
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getIdentity`]: https://docs.chui.network/developing/clients/jsonrpc-api#getidentity
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getInflationGovernor`]: https://docs.chui.network/developing/clients/jsonrpc-api#getinflationgovernor
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationRate`]: https://docs.chui.network/developing/clients/jsonrpc-api#getinflationrate
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getInflationReward`]: https://docs.chui.network/developing/clients/jsonrpc-api#getinflationreward
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Returns the current chuiversion running on the node.
    ///
    /// # RPC Reference
    ///
    /// This method corresponds directly to the [`getVersion`] RPC method.
    ///
    /// [`getVersion`]: https://docs.chui.network/developing/clients/jsonrpc-api#getversion
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// let version = semver::Version::parse(&version.chui_core)?;
    ...
    /// method.
    ///
    /// [`minimumLedgerSlot`]: https://docs.chui.network/developing/clients/jsonrpc-api#minimumledgerslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getAccountInfo`]: https://docs.chui.network/developing/clients/jsonrpc-api#getaccountinfo
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getMaxRetransmitSlot`]: https://docs.chui.network/developing/clients/jsonrpc-api#getmaxretransmitslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// Get the max slot seen from after [shred](https://docs.chui.network/terminology#shred) insert.
    ///
    /// # RPC Reference
    ///
    ...
    ///
    /// [`getMaxShredInsertSlot`]: https://docs.chui.network/developing/clients/jsonrpc-api#getmaxshredinsertslot
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getMultipleAccounts`]: https://docs.chui.network/developing/clients/jsonrpc-api#getmultipleaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use chui_account_decoder::UiAccountEncoding;
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let bob = Keypair::new();
    /// let pubkeys = vec![alice.pubkey(), bob.pubkey()];
    ...
    ///
    /// [`getMinimumBalanceForRentExemption`]: https://docs.chui.network/developing/clients/jsonrpc-api#getminimumbalanceforrentexemption
    ///
    /// # Examples
    ///
    /// ```
    ...
    ///
    /// [`getBalance`]: https://docs.chui.network/developing/clients/jsonrpc-api#getbalance
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// method.
    ///
    /// [`getProgramAccounts`]: https://docs.chui.network/developing/clients/jsonrpc-api#getprogramaccounts
    ///
    /// # Examples
    ///
    /// ```
    ...
    /// #     commitment_config::CommitmentConfig,
    /// # };
    /// # use chui_account_decoder::{UiDataSliceConfig, UiAccountEncoding};
    /// # let rpc_client = RpcClient::new_mock("succeeds".to_string());
    /// # let alice = Keypair::new();
    /// # let base64_bytes = "\
