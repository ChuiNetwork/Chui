...
of the [Chui Labs](https://hub.docker.com/chuilabs/) Docker Hub
organization.
...
1. Run `CUI_ALLOCATE_TTY=1 CUI_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull chuilabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `CUI_ALLOCATE_TTY=1 CUI_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull chuilabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
