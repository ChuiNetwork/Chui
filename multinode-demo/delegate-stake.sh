...
function get_token_capitalization {
    ...
    totalSupplySol=$((totalSupplyLamports / LAMPORTS_PER_CUI))
...
totalAccountBalancesSol=$((totalAccountBalancesLamports / LAMPORTS_PER_CUI))
...
printf "Total CUI in all Account Balances: %'d\n" "$grandTotalAccountBalancesSol"
