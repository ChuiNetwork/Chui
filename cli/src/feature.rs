use {
    ...
    chui_clap_utils::{input_parsers::*, input_validators::*, keypair::*},
    chui_cli_output::{QuietDisplay, VerboseDisplay},
    chui_client::{client_error::ClientError, rpc_client::RpcClient},
...
fn feature_activation_allowed(
    ...
    let my_feature_set = chui_version::Version::default().feature_set;
