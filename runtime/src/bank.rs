...
impl Bank {
    ...
    pub fn new_with_paths(
        genesis_config: &GenesisConfig,
        // TODO(chui): Remove option, currently need for Bank::new/default, that is used for tests
        ...
        let evm_state = if let Some((evm_state_path, evm_genesis_path)) = evm_paths {
            ...
            //TODO(chui): Rename default to test
    ...
    pub fn evm_burn_fee_activated(&self) -> bool {
        self.feature_set
            .is_active(&feature_set::chui::burn_fee::id())
    }
    ...
    fn check_message_for_nonce(
            ...
            .is_active(&feature_set::nonce_must_be_authorized::ID)
        {
            ...
            .feature_set
            .is_active(&feature_set::chui::disable_durable_nonce::id())
        {
            return None;
        }
    ...
    fn execute_loaded_transaction(
            ...
            if let Some(state) = &evm_patch {
                let evm_executor = evm_state::Executor::with_config(
                    ...
                    evm_state::executor::FeatureSet::new(
                        self.feature_set
                            .is_active(&solana_sdk::feature_set::chui::unsigned_tx_fix::id()),
                        self.feature_set
                            .is_active(&solana_sdk::feature_set::chui::clear_logs_on_error::id()),
                        self.feature_set
                            .is_active(&solana_sdk::feature_set::chui::accept_zero_gas_price_with_native_fee::id()),
                    ),
                );
                Some(evm_executor)
            } else {
        ...
        //TODO(chui): Move evm_state apply to update executors
        let evm_new_error_handling = self
            .feature_set
            .is_active(&solana_sdk::feature_set::chui::evm_new_error_handling::id());
        ...
        if let Some(evm_executor) = evm_executor {
                ...
                && evm_new_error_handling
            {
                let clear_logs = self
                    .feature_set
                    .is_active(&solana_sdk::feature_set::chui::clear_logs_on_native_error::id());
                evm_patch
                    .as_mut()
    ...
    fn fix_spv_proofs_evm(&self) -> bool {
        self.feature_set
            .is_active(&feature_set::chui::hardfork_pack::id())
    }
    ...
    fn apply_feature_activations(
        ...
        if !debug_do_not_add_builtins {
            ...
            self.reconfigure_token2_native_mint(
                new_feature_activations.contains(&feature_set::chui::hardfork_pack::id()),
            );
        }
    ...
    fn reconfigure_token2_native_mint(&mut self, reconfigure_token2_native_mint_chui: bool) {
        ...
        let reconfigure_token2_native_mint =
            reconfigure_token2_native_mint_old || reconfigure_token2_native_mint_chui;
    ...
    fn ensure_no_storage_rewards_pool(&mut self) {
        let purge_window_epoch = match self.cluster_type() {
            ...
            // tds is not exist in chui so dont do this
...
pub(crate) mod tests {
    ...
    fn test_interleaving_locks_evm_tx() {
        ...
        bank.activate_feature(&feature_set::chui::evm_instruction_borsh_serialization::id());
    ...
    fn test_evm_second_tx_with_same_nonce() {
        ...
        bank.activate_feature(&feature_set::chui::native_swap_in_evm_history::id());
        bank.activate_feature(&feature_set::chui::evm_new_error_handling::id());
        bank.activate_feature(&feature_set::chui::evm_instruction_borsh_serialization::id());
        let recent_hash = genesis_config.hash();
    ...
    fn test_evm_revert_tx() {
        ...
        let state_swapper = evm_state
            .get_account_state(*solana_evm_loader_program::precompiles::ETH_TO_CUI_ADDR)
            .unwrap_or_default();
    ...
    fn test_bank_hash_internal_state_verify_transfer_evm() {
        ...
        bank0.activate_feature(&feature_set::chui::evm_instruction_borsh_serialization::id());
    ...
    fn test_get_inflation_start_slot_devnet_testnet() {
        ...
        genesis_config
            .accounts
            .remove(&feature_set::full_inflation::devnet_and_testnet_chui_mainnet::id())
            .unwrap();
        ...
        bank.store_account(
            &feature_set::full_inflation::devnet_and_testnet_chui_mainnet::id(),
            &feature::create_account(
                &Feature {
                    activated_at: Some(2),
                },
