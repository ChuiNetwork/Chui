...
use {
    chui_gossip::{cluster_info, gossip_error::GossipError},
    chui_ledger::blockstore_db,
};
...
pub enum Error {
    ...
    Send,
    Blockstore(blockstore_db::BlockstoreError),
...
impl std::convert::From<blockstore_db::BlockstoreError> for Error {
    fn from(e: blockstore_db::BlockstoreError) -> Error {
        Error::Blockstore(e)
    }
}
