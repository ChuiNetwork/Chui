    ...
    fn stake_subcommands(self) -> Self {
            ...
            SubCommand::with_name("create-stake-account-checked")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount_or_all)
                        .required(true)
                        .help("The amount to send to the stake account, in CUI; accepts keyword ALL")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
            ...
            SubCommand::with_name("split-stake")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount)
                        .required(true)
                        .help("The amount to move into the new stake account, in CUI")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
        ...
        .subcommand(
            SubCommand::with_name("withdraw-stake")
                .about("Withdraw the unstaked CUI from the stake account")
                .arg(
                    pubkey!(Arg::with_name("stake_account_pubkey")
                        .index(1)
                        .value_name("STAKE_ACCOUNT_ADDRESS")
                ...
                .arg(
                    Arg::with_name("amount")
                        ...
                        .validator(is_amount_or_all)
                        .required(true)
                        .help("The amount to withdraw from the stake account, in CUI")
                )
                .arg(
                    Arg::with_name("seed")
                        .long("seed")
            ...
            SubCommand::with_name("stake-account")
                ...
                .arg(
                    Arg::with_name("lamports")
                        .long("lamports")
                        .takes_value(false)
                        .help("Display balance in lamports instead of CUI")
                )
                .arg(
...
pub fn parse_split_stake(
    ...
    let lamports = lamports_of_cui(matches, "amount").unwrap();
    let seed = matches.value_of("seed").map(|s| s.to_string());
...
mod tests {
    ...
    fn test_parse_command() {
        ...
        let authorized = chui_sdk::pubkey::new_rand();
        ...
        let vote_account_pubkey = chui_sdk::pubkey::new_rand();
        ...
        let key1 = chui_sdk::pubkey::new_rand();
        ...
        let key2 = chui_sdk::pubkey::new_rand();
