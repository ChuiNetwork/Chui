...
function display_results_summary {
    ...
    stake_account_balance_total_sol="$(bc <<< "scale=3; $stake_account_balance_total/$LAMPORTS_PER_CUI")"
    system_account_balance_sol="$(bc <<< "scale=3; $system_account_balance/$LAMPORTS_PER_CUI")"
    
    all_account_total_balance="$(bc <<< "scale=3; $system_account_balance+$stake_account_balance_total")"
    all_account_total_balance_sol="$(bc <<< "scale=3; ($system_account_balance+$stake_account_balance_total)/$LAMPORTS_PER_CUI")"
...
LAMPORTS_PER_CUI=1000000000 # 1 billion
