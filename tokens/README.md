...
Currently, this will subtract 1 CUI from each allocation and store it the
recipient address. That CUI can be used to pay transaction fees on staking
...
Distributing SPL Tokens works very similarly to distributing CUI, but requires
...
As with CUI, you can List the differences between a list of expected
