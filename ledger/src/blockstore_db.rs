...
pub enum BlockstoreError {
    ...
    Other(&'static str), // TODO(chui): remove, use specific error variant
}
...
impl Rocks {
    fn open(
        ...
        // this is only needed for LedgerCleanupService. so guard with PrimaryOnly (i.e. running chui-validator)
