...
use {
    ...
    rand::{thread_rng, Rng},
    rayon::prelude::*,
    chui_core::banking_stage::BankingStage,
    ...
    chui_perf::packet::to_packet_batches,
    chui_poh::poh_recorder::{create_test_recorder, PohRecorder, WorkingBankEntry},
    chui_runtime::{
...
fn make_accounts_txs(
    ...
    (0..total_num_transactions)
        ...
        .map(|_| {
            ...
            if !same_payer {
                new.message.account_keys[0] = chui_sdk::pubkey::new_rand();
            }
            new.message.account_keys[1] = chui_sdk::pubkey::new_rand();
...
fn main() {
    ...
    let ledger_path = get_tmp_ledger_path!();
    {
        ...
        let mut root = 1;
        let collector = chui_sdk::pubkey::new_rand();
        let config = Config {
