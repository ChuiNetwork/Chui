use {
    ...
    bincode::deserialize,
    serde_json::Value,
    chui_config_program::{get_config_data, ConfigKeys},
    chui_sdk::{
        pubkey::Pubkey,
...
mod test {
    use {
        ...
        chui_config_program::create_config_account, chui_sdk::account::ReadableAccount,
    };
    ...
    fn test_parse_config() {
        ...
        let info_pubkey = chui_sdk::pubkey::new_rand();
        ...
        assert_eq!(
            ...
            ConfigAccountType::ValidatorInfo(UiConfig {
                ...
                config_data: serde_json::from_str(r#"{"name":"Chui"}"#).unwrap(),
            }),
        );
