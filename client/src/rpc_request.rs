use {
    ...
    chui_sdk::{clock::Slot, pubkey::Pubkey},
    std::fmt,
    thiserror::Error,
};
...
pub enum RpcRequest {
    ...
    /// Chui Account scope
    GetChuiAccountsByOperationalKey,
    GetChuiAccountsByOwnerKey,
    GetChuiRelyingPartiesByOwnerKey,
...
impl fmt::Display for RpcRequest {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        let method = match self {
            ...
            RpcRequest::GetChuiAccountsByOperationalKey => "getChuiAccountsByOperationalKey",
            RpcRequest::GetChuiAccountsByOwnerKey => "getChuiAccountsByOwnerKey",
            RpcRequest::GetChuiRelyingPartiesByOwnerKey => "getChuiRelyingPartiesByOwnerKey",
...
mod tests {
    use {
        ...
        chui_sdk::commitment_config::{CommitmentConfig, CommitmentLevel},
    };
    ...
    fn test_build_request_json_config_options() {
        ...
        let mint = chui_sdk::pubkey::new_rand();
