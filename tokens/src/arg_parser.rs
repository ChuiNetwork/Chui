    ...
    App::new(crate_name!())
        ...
        .arg(
            Arg::with_name("url")
                ...
                .takes_value(true)
                .value_name("URL")
                .help("RPC entrypoint address. i.e. https://api.devnet.chui.network"),
        )
        .subcommand(
            SubCommand::with_name("distribute-tokens")
                .about("Distribute CUI")
                .arg(
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in CUI"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("distribute-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_cui")
                        .default_value("1.0")
                        .long("unlocked-cui")
                        .takes_value(true)
                        .value_name("CUI_AMOUNT")
                        .help("Amount of CUI to put in system account to pay for fees"),
                )
                .arg(
