...
impl Default for Config {
    fn default() -> Self {
        ...
        let json_rpc_url = "https://api.mainnet.chui.network".to_string();
...
mod test {
    ...
    fn compute_websocket_url() {
        assert_eq!(
            Config::compute_websocket_url("http://api.devnet.chui.network"),
            "ws://api.devnet.chui.network/".to_string()
        );

        assert_eq!(
            Config::compute_websocket_url("https://api.devnet.chui.network"),
            "wss://api.devnet.chui.network/".to_string()
        );
