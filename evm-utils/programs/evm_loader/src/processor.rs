...
impl EvmProcessor {
    pub fn process_instruction(
        ...
        let cross_execution_enabled = invoke_context
            .feature_set
            .is_active(&solana_sdk::feature_set::chui::evm_cross_execution::id());
        let register_swap_tx_in_evm = invoke_context
            .feature_set
            .is_active(&solana_sdk::feature_set::chui::native_swap_in_evm_history::id());
        ...
        let ignore_reset_on_cleared = invoke_context
            .feature_set
            .is_active(&solana_sdk::feature_set::chui::ignore_reset_on_cleared::id());
        let free_ownership_require_signer = invoke_context
            .feature_set
            .is_active(&solana_sdk::feature_set::chui::free_ownership_require_signer::id());
        let borsh_serialization_enabled = invoke_context
            .feature_set
            .is_active(&solana_sdk::feature_set::chui::evm_instruction_borsh_serialization::id());
    ...
    fn process_execute_tx(
        ...
        fn precompile_set(
            ...
            match (support_precompile, evm_new_precompiles) {
                ...
                (true, false) => precompiles::PrecompileSet::ChuiClassic,
                (true, true) => precompiles::PrecompileSet::ChuiNext,
            }
        }
        ...
        let result = match tx {
            ExecuteTransaction::Signed { tx } => {
                ...
                let activate_precompile = precompile_set(
                    ...
                    invoke_context
                        .feature_set
                        .is_active(&solana_sdk::feature_set::chui::evm_new_precompiles::id()),
                );
...
mod test {
        ...
        fn process_transaction(&mut self, ixs: Vec<Instruction>) -> Result<(), InstructionError> {
            ...
            let evm_executor = evm_state::Executor::with_config(
                ...
                evm::EvmConfig::new(
                    evm::TEST_CHAIN_ID,
                    self.feature_set
                        .is_active(&solana_sdk::feature_set::chui::burn_fee::id()),
                ),
                evm_state::executor::FeatureSet::new(
                    ...
                    self.feature_set.is_active(
                        &solana_sdk::feature_set::chui::accept_zero_gas_price_with_native_fee::id(
                        ),
                    ),
                ),
            );
            ...
            for instruction in message.instructions() {
                    ...
                    .result
                {
                    ...
                    let clear_logs = self.feature_set.is_active(
                        &solana_sdk::feature_set::chui::clear_logs_on_native_error::id(),
                    );
                    self.evm_state
    ...
    fn execute_tx() {
        ...
        evm_context.disable_feature(&solana_sdk::feature_set::chui::burn_fee::id());
        let secret_key = evm::SecretKey::from_slice(&SECRET_KEY_DUMMY).unwrap();
    ...
    fn test_revert_clears_logs() {
...

        {
            ...
            // Reverted tx with clear_logs_on_error disabled don't clear logs
            {
                let mut evm_context = evm_context.clone(); // make copy for test
                evm_context
                    .disable_feature(&solana_sdk::feature_set::chui::clear_logs_on_error::id());
