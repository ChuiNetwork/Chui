use {
    ...
    chui_runtime::{bank::Bank, epoch_stakes::NodeIdToVoteAccounts},
    chui_sdk::{
...
#[cfg(test)]
mod tests {
    use {super::*, chui_runtime::epoch_stakes::NodeVoteAccounts};
    ...
    fn test_best_peer_2() {
        ...
        let k1 = chui_sdk::pubkey::new_rand();
        let k2 = chui_sdk::pubkey::new_rand();
    ...
    fn test_best_completed_slot_peer() {
        ...
        for ci in contact_infos.iter_mut() {
            ci.id = chui_sdk::pubkey::new_rand();
        }
        let slot = 9;
