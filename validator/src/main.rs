...
pub fn main() {
    ...
    let matches = App::new(crate_name!()).about(crate_description!())
        ...
        .arg(
            Arg::with_name("evm_state_rpc_port")
                ...
                .validator(chui_validator::port_validator)
        ...
        .arg(
            Arg::with_name("dynamic_port_range")
                ...
                .validator(chui_validator::port_range_validator)
        ...
        .arg(
            Arg::with_name("account_indexes")
                ...
                .possible_values(&[
                    ...
                    "spl-token-owner",
                    "spl-token-mint",
                    "chui-accounts-storages",
                    "chui-accounts-owners",
                    "chui-accounts-operationals",
                    "chui-relying-party-owners",
                ])
                .value_name("INDEX")
    ...
    let logfile = {
        let logfile = matches
            .value_of("logfile")
            .map(|s| s.into())
            .unwrap_or_else(|| format!("chui-validator-{}.log", identity_keypair.pubkey()));
...
fn process_account_indexes(matches: &ArgMatches) -> AccountSecondaryIndexes {
    let account_indexes: HashSet<AccountIndex> = matches
        ...
        .map(|value| match value {
            ...
            "chui-accounts-storages" => AccountIndex::ChuiAccountStorage,
            "chui-accounts-owners" => AccountIndex::ChuiAccountOwner,
            "chui-accounts-operationals" => AccountIndex::ChuiAccountOperational,
            "chui-relying-party-owners" => AccountIndex::ChuiRelyingOwner,
