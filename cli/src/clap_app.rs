use {
    ...
    chui_clap_utils::{self, nonce::NonceArgs, offline::OfflineArgs, fee_payer::fee_payer_arg, memo::memo_arg, input_validators::*, keypair::*},
    chui_cli_config::CONFIG_FILE,
};
    ...
    App::new(name)
            ...
            SubCommand::with_name("airdrop")
                ...
                .arg(
                    Arg::with_name("faucet_port")
                        ...
                        .takes_value(true)
                        .default_value(chui_faucet::faucet::FAUCET_PORT_STR)
        ...
        .arg(
            Arg::with_name("websocket_url")
                ...
                .global(true)
                .validator(is_url)
                .help("WebSocket URL for the chuicluster"),
        )
        .arg(
